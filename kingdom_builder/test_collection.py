...
class TestCollection(unittest.TestCase):
    def test_classVersion(self):
        collection = dominion.Collection('kingdom_builder/test_decks/test_deck.yml')
    ...
    def test_card_add(self):
        collection = dominion.Collection('kingdom_builder/test_decks/test_deck_2.yml')
        self.assertEquals(collection.cards, {
            'FileCard1': dominion.Deck(dict(name='FileCard1', set='FileSetA',
                                            type='Action')),
    ...
    def test_create_decks(self):
        collection = dominion.Collection('kingdom_builder/test_decks/test_deck_3.yml')
